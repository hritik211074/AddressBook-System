...
app.addContact("Personal", "suresh", "kumar", "123 Main St", "New York", "NY", "10001", "9876543210", "john.doe@example.com");
app.viewContacts("Personal");
app.createAddressBook("Work");
app.addContact("Work", "jimmy", "maurya", "456 Market St", "Berkhera pathani", "California", "90001", "9123456789", "alice.smith@example.com");
app.viewContacts("Work");
app.editContact("Work", "parag", "agrawal", { phone: "9876543211", email: "parag.new@example.com" });
app.deleteContact("Work","ramesh","yadav");
